...
io.stdout:write(string.format([[local function lzss_decompress(a)local b,c,d,e,j,i,h,g=1,'',''while b<=#a do
e=c.byte(a,b)b=b+1
...
return c end
return assert(load(lzss_decompress(%s), "=bootstrap"))(lzss_decompress)]], mkstr(M.compress(f))))